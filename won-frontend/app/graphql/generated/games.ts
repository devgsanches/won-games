...
export type GetGamesQuery = { __typename?: 'Query', games: Array<{ __typename?: 'Game', title: string, slug?: string | null, price: number, cover: { __typename?: 'UploadFile', url: string }, developers: Array<{ __typename?: 'Developer', name: string }> }> };
