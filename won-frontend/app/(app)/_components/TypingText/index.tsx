...
const TypingText = ({
  ...
  const longestText = textArray.reduce(
  ...
  return createElement(
    ...
    {
      ref: containerRef,
      className: `inline-grid whitespace-pre-wrap tracking-tight ${className}`,
      ...props
    },

    <span
      className="invisible h-0 overflow-hidden col-start-1 row-start-1"
      aria-hidden="true"
    >
      {longestText}
    </span>,
    ...
    <span
      className="col-start-1 row-start-1 inline"
